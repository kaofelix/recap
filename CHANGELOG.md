...
- **Scrolling no longer rubber-bands past the app edges** — Recap now disables overscroll bounce in the diff view and across the app shell, so trackpad scrolling no longer pulls the UI beyond its bounds.
